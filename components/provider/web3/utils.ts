...
export type Web3State = {
    ...
    hooks: Web3Hooks;
} & Nullable<Web3Dependecies>

export const createDefultState = () => {
    return {
        ethereum: null,
        provider: null,
        contract: null,
...
export const createWeb3State = ({ethereum, provider, contract, isLoading}: Web3Dependecies & {isLoading: boolean}) => {
    return {
        ethereum,
        provider,
        contract,
